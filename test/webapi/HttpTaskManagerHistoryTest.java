...
public class HttpTaskManagerHistoryTest {
    ...
    public void testAddTaskSuccess() throws IOException, InterruptedException {
        ...
        int idSubTask1 = manager.getSubtasks().get(0).getId();
        ...
        int idSubTask2 = manager.getSubtasks().get(1).getId();

        manager.getTaskById(idTask1);
        manager.getTaskById(idTask2);
        manager.getTaskById(idTask3);
